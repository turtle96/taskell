...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks() {
        try {
            ...
            collectParcel = new TaskBuilder().withDescription("Collect parcel").withTaskType(Task.EVENT_TASK).withStartDate("10-1-2100").withEndDate("1-12-2100").withStartTime("12:30AM").withEndTime("12:45AM").withTaskPriority("0").withTags("owesMoney").build();
            discardBooks = new TaskBuilder().withDescription("Discard books").withTaskType(Task.EVENT_TASK).withStartDate("10-1-2100").withEndDate("1-12-2100").withStartTime("12:30AM").withEndTime("12:45AM").withTaskPriority("0").build();
            editPowerpoint = new TaskBuilder().withDescription("Edit powerpoint").withTaskType(Task.EVENT_TASK).withStartDate("10-1-2100").withEndDate("1-12-2100").withStartTime("12:30AM").withEndTime("12:45AM").withTaskPriority("0").build();
            fixbugs = new TaskBuilder().withDescription("Fix bugs").withTaskType(Task.EVENT_TASK).withStartDate("19-1-2100").withEndDate("1-12-2100").withStartTime("12:30AM").withEndTime("12:45AM").withTaskPriority("0").build();
            getNewUniform = new TaskBuilder().withDescription("Get new uniform").withTaskType(Task.EVENT_TASK).withStartDate("19-1-2100").withEndDate("1-12-2100").withStartTime("12:30AM").withEndTime("12:45AM").withTaskPriority("0").build();

            //Manually added
            holdMeeting = new TaskBuilder().withDescription("Hold meeting").withTaskType(Task.EVENT_TASK).withStartDate("19-1-2100").withEndDate("1-12-2100").withStartTime("12:30AM").withEndTime("12:45AM").withTaskPriority("0").build();
            inspectWarehouse = new TaskBuilder().withDescription("Inspect warehouse").withTaskType(Task.EVENT_TASK).withStartDate("19-1-2100").withEndDate("1-12-2100").withStartTime("12:30AM").withEndTime("12:45AM").withTaskPriority("0").build();
