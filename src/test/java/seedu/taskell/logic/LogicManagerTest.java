...
public class LogicManagerTest {
    ...
    class TestDataHelper {
        ...
        Task generateTask(int seed) throws Exception {
            return new Task(new Description("Task " + seed), new TaskDate("" + Math.abs(seed)),
                    new TaskTime(seed + "@time"), new TaskPriority("House of " + seed),
        ...
        Task generateTaskWithDescription(String name) throws Exception {
            return new Task(new Description(name), new TaskDate("1"), new TaskTime("1@email"),
                    new TaskPriority("House of 1"), new UniqueTagList(new Tag("tag")));
        }
    }
}
