...
public class LogicManagerTest {
    ...
    public void execute_add_ValidTaskWithMultipleOn() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping on 3-3-3333", "2-2-2222", "2-2-2222", TaskTime.DEFAULT_START_TIME, TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
    ...
    public void execute_add_ValidTaskWithMultipleAt() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping at 11.59pm", TaskDate.DEFAULT_DATE, TaskDate.DEFAULT_DATE, "11.58pm", TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidTaskWithMultipleByDate() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping by 3-3-3333", TaskDate.DEFAULT_DATE, "2-2-2222", TaskTime.getTimeNow(), TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidTaskWithMultipleByTime() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping by 11.59pm", TaskDate.DEFAULT_DATE, TaskDate.DEFAULT_DATE, TaskTime.getTimeNow(), "11.58pm", "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidTaskWithMultipleFromDate() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping from 3-3-3333", "2-2-2222", "2-2-2222", TaskTime.DEFAULT_START_TIME, TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidTaskWithMultipleFromTime() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping from 11.59pm", TaskDate.DEFAULT_DATE, TaskDate.DEFAULT_DATE, "11.58pm", TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidTaskWithMultipleToDate() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping to 3-3-3333", TaskDate.DEFAULT_DATE, "2-2-2222", TaskTime.getTimeNow(), TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidTaskWithMultipleToTime() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping to 11.59pm", TaskDate.DEFAULT_DATE, TaskDate.DEFAULT_DATE, TaskTime.getTimeNow(), "11.58pm", "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidEventWithByTime() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping", TaskDate.getTodayDate(), TaskDate.getTodayDate(), TaskTime.getTimeNow(), "11:59pm", "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidEventWithAtTime() throws Exception {
        ...
        Task toBeAdded = new EventTask("go shopping", TaskDate.getTodayDate(), TaskDate.getTodayDate(), "11:59pm", TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidEventWithTagNotAtTheEnd() throws Exception {
        ...
        Task toBeAdded = new EventTask("go to Mavis's house", TaskDate.getTodayDate(), TaskDate.getTodayDate(), "10:00am", TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList(new Tag("girlfriend")));
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidEventWithEndTimeBeforeStartTime() throws Exception {
        ...
        Task toBeAdded = new EventTask("stayover at Juliet's house", TaskDate.getTodayDate(), TaskDate.getTodayDate(), "7:00pm", "10:00am", "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    public void execute_add_ValidEventWithSameDayNameInWeekAsToday() throws Exception {
        ...
        Task toBeAdded = new EventTask("go school", today.getNextWeek().toString(), tomorrow.toString(), TaskTime.DEFAULT_START_TIME, TaskTime.DEFAULT_END_TIME, "0", "incomplete", new UniqueTagList());
        TaskManager expectedAB = new TaskManager();
        expectedAB.addTask(toBeAdded);
        // execute command and verify result
        assertCommandBehavior(description,
    ...
    class TestDataHelper{
        ...
        Task askBoon() throws Exception {
            ...
            return new Task(description, taskType, startDate, endDate, startTime, endTime, privatetaskPriority, initialStatus, tags);
        }
         ...
         */
        Task generateEventTask(String description, String startDate, String endDate, String startTime, String endTime, String taskPriority, String taskStatus) throws Exception{
            return new Task(
