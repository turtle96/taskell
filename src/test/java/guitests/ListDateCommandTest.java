...
public class ListDateCommandTest extends TaskManagerGuiTest {
    ...
    public void listDate() throws IllegalValueException {
        ...
        assertlistDateSuccess(currentList, date, td.archivePastEmails, td.borrowBooks);
    ...
    /**
     * Runs the list date command to list tasks on a specified
     * date and confirms the result is correct.
     * 
     * @param date
     *            e.g. to list tasks on date "1-1-2016", "1-1-2016"
