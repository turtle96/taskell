...
public class Parser {
    ...
    private Command prepareAdd(String args) {
        ...
        if ((TaskDate.isValidToday(startDate) && !hasTaskComponentArray[START_TIME_COMPONENT])
                || startDate.equals(TaskDate.DEFAULT_DATE) && !hasTaskComponentArray[START_TIME_COMPONENT]) {
